            ...
            return (
              <div key={_id}>
                ...
                <div className="max-w-sm bg-white shadow-lg rounded-lg overflow-hidden">
                  <img
                    className="max-w-full h-56 object-cover object-center"
                    src={image}
                    alt="avatar"
                  />
                  <div className="flex items-center px-6 py-3 bg-gray-900">
                    ...
                    <Link to="/products">
                      <h1 className="mx-3 bg-gradient-to-r from-primary to-neutral text-black font-semibold text-sm uppercase">
                        Book Now
                      </h1>
                    </Link>
                  </div>
                  <div className="px-4">
                    <p className="text-sm uppercase font-semibold my-2">
                      {product_name}
                    </p>
                    ...
                    <div className="flex justify-between">
                      <div className="my-2">
                        <p className="font-semibold text-base mb-2">Vendor</p>
                      ...
                      <div className="my-2">
                        <p className="font-semibold bg-secondary rounded-full text-center text-base mb-2">
                          {condition}
                        </p>
