...
export const Contact = () => {
  ...
  return (
    <div class="container my-24 mx-auto md:px-6">
      ...
      <section>
        <div class="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat bg-[url('https://i.ibb.co/DWNL7fh/contactimage.jpg')]"></div>
          ...
          <div class="block rounded-lg bg-[hsla(0,0%,100%,0.7)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,5%,0.7)] dark:shadow-black/20 md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px]">
            <div class="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div class="mx-auto mb-12 text-center lg:mb-0">
                ...
                <h6 class="font-medium">Dhaka, 1000</h6>
              </div>
              <div class="mx-auto mb-6 text-center md:mb-0">
                ...
                <h6 class="font-medium">+880 1700 960003</h6>
              </div>
              <div class="mx-auto text-center">
                ...
                <h6 class="font-medium">Tax ID: 20-1234567</h6>
              </div>
            </div>
